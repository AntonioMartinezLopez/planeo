...
import "planeo/services/core/internal/resources/organization/models"
...
type GetOrganizationsOutput struct {
	Body []models.Organization `json:"organizations" doc:"Array of organizations the user belongs to"`
}
