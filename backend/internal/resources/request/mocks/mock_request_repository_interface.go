...
import (
	context "context"
	dto "planeo/api/internal/resources/request/dto"

	mock "github.com/stretchr/testify/mock"

	models "planeo/api/internal/resources/request/models"
)
...
// CreateRequest provides a mock function with given fields: ctx, organizationId, requestInput
func (_m *MockRequestRepositoryInterface) CreateRequest(ctx context.Context, organizationId int, requestInput dto.CreateRequestInputBody) error {
	ret := _m.Called(ctx, organizationId, requestInput)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int, dto.CreateRequestInputBody) error); ok {
		r0 = rf(ctx, organizationId, requestInput)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - organizationId int
//   - requestInput dto.CreateRequestInputBody
func (_e *MockRequestRepositoryInterface_Expecter) CreateRequest(ctx interface{}, organizationId interface{}, requestInput interface{}) *MockRequestRepositoryInterface_CreateRequest_Call {
	return &MockRequestRepositoryInterface_CreateRequest_Call{Call: _e.mock.On("CreateRequest", ctx, organizationId, requestInput)}
}

func (_c *MockRequestRepositoryInterface_CreateRequest_Call) Run(run func(ctx context.Context, organizationId int, requestInput dto.CreateRequestInputBody)) *MockRequestRepositoryInterface_CreateRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int), args[2].(dto.CreateRequestInputBody))
	})
	return _c
}
...
func (_c *MockRequestRepositoryInterface_CreateRequest_Call) RunAndReturn(run func(context.Context, int, dto.CreateRequestInputBody) error) *MockRequestRepositoryInterface_CreateRequest_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateRequest provides a mock function with given fields: ctx, organizationId, requestId, requestInput
func (_m *MockRequestRepositoryInterface) UpdateRequest(ctx context.Context, organizationId int, requestId int, requestInput dto.UpdateRequestInputBody) error {
	ret := _m.Called(ctx, organizationId, requestId, requestInput)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int, dto.UpdateRequestInputBody) error); ok {
		r0 = rf(ctx, organizationId, requestId, requestInput)
	} else {
		r0 = ret.Error(0)
	}
...
//   - organizationId int
//   - requestId int
//   - requestInput dto.UpdateRequestInputBody
func (_e *MockRequestRepositoryInterface_Expecter) UpdateRequest(ctx interface{}, organizationId interface{}, requestId interface{}, requestInput interface{}) *MockRequestRepositoryInterface_UpdateRequest_Call {
	return &MockRequestRepositoryInterface_UpdateRequest_Call{Call: _e.mock.On("UpdateRequest", ctx, organizationId, requestId, requestInput)}
}

func (_c *MockRequestRepositoryInterface_UpdateRequest_Call) Run(run func(ctx context.Context, organizationId int, requestId int, requestInput dto.UpdateRequestInputBody)) *MockRequestRepositoryInterface_UpdateRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int), args[2].(int), args[3].(dto.UpdateRequestInputBody))
	})
	return _c
}
...
func (_c *MockRequestRepositoryInterface_UpdateRequest_Call) RunAndReturn(run func(context.Context, int, int, dto.UpdateRequestInputBody) error) *MockRequestRepositoryInterface_UpdateRequest_Call {
	_c.Call.Return(run)
	return _c
}
